...
INSERT INTO `auto` (`idAuto`, `codigoAuto`, `idTipoAuto`, `descripcionTipo`, `idMarca`, `marca`, `idModelo`, `modelo`, `anio`, `numpuertas`, `precio`, `urlFoto`, `flagEstado`) VALUES (1,'TY1001',1,'Auto',1,'Auto',1,'Yaris',2015,4,60000,NULL,'\0'),(2,'TY1002',1,'Auto',1,'Auto',1,'Corolla',2010,4,30000,NULL,'\0'),(3,'AU00003',19,'dsa',2,'Toyota',6,'Sedan',2015,NULL,60000,NULL,''),(4,'AU00004',19,'dsa',2,'Toyota',6,'Sedan',2015,NULL,60000,NULL,''),(5,'AU00005',19,'dsa',2,'Toyota',6,'Sedan',2015,NULL,60000,NULL,''),(6,'AU00006',19,'dsa',2,'Toyota',6,'Sedan',2015,NULL,60000,NULL,'');
...
INSERT INTO `cotizacion` (`idCotizacion`, `codigoCotizacion`, `idVendedor`, `idCliente`, `idTipoMoneda`, `descripTipoMoneda`, `importe`, `flagAprobado`, `flagAnulado`, `flagEstado`) VALUES (1,'COT001',1,1,1,'DOLARES',20000,'','\0',''),(2,'COT002',1,1,1,'DOLARES',50000,'','\0',''),(3,'COT003',1,1,8,NULL,60000,'','\0',''),(4,'COT004',1,2,8,NULL,90000,'','\0',''),(5,'COT005',1,1,8,'DOLARES',30000,'\0','\0',''),(6,'COT006',1,1,8,'DOLARES',60000,'\0','\0',''),(7,'COT007',1,1,8,'DOLARES',120000,'\0','\0','');
...
INSERT INTO `sucursal` (`idSucursal`, `codigoDepartamento`, `codigoProvincia`, `codigoUbigeo`, `nombre`, `flagEstado`) VALUES (1,'15','1501','150101','Sede Wilson',''),(2,'15','1501','150122','Sede Miraflores','');
...
INSERT INTO `usuario` (`IdUsuario`, `idVendedor`, `correo`, `clave`, `flagHabilitado`, `flagEstado`, `flagNuevo`) VALUES (1,NULL,'luis@gmail.com','e10adc3949ba59abbe56e057f20f883e','','',''),(7,7,'luisalmeyda901@gmail.com','a6565161e23951956fbf3932f07b559b','','','');
...
INSERT INTO `vendedor` (`idVendedor`, `idSupervisor`, `codigoVendedor`, `docIdentidad`, `nombres`, `apellidoPaterno`, `apellidoMaterno`, `telefono`, `correo`, `idSucursal`, `nombreSucursal`, `fechaNacimiento`, `fechaRegistro`, `flagHabilitado`, `flagEstado`) VALUES (1,NULL,'V00001','12345678','Pepe','Ramirez','Vasquez','123456789','pp@gmail.com',1,'LIMA','1980-01-01 00:00:00','2015-11-25 00:00:00','',''),(7,NULL,'V00002','78945612','ASD','ASD','ASD','789456123','luisalmeyda901@gmail.com',2,NULL,'2015-11-30 19:00:00','2015-12-07 23:06:42','','');
...
-- Dump completed on 2015-12-17  0:29:25
